...
class Settings {
	...
	public static function registerSettings() {
		...
		Settings::register( Settings::KEY_CONSENT_EXPLAIN_TEXT, ['type' => 'text', 'default' =>  __( 'This site uses functional cookies and external scripts to improve your experience.', 'wp-gdpr-compliance' ) ] );
		...
		Settings::register( Settings::KEY_CONSENT_MODAL_TEXT, ['type' => 'textarea', 'default' =>
