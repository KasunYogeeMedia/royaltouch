...
$premiumDashboardUrl = esc_url(Config::premiumDashboardUrl());
	...
	<div class="grid-x grid-margin-x grid-margin-y">
		<div class="cell large-12">
			<div class="wpgdprc-form__intro">
				...
				<p class="wpgdprc-form__text <?php if( !$premium ) echo 'hidden'; ?>">
                    <?php printf(esc_html_x('Style your Consent Bar and Consent Pop-up via the Cookie Information dashboard %1s.', 'admin', 'wp-gdpr-compliance'), "<a href=\"$premiumDashboardUrl\">".esc_html_x('here', 'admin', 'wp-gdpr-compliance')."</a>"); ?>
				</p>
			</div>
		</div>
