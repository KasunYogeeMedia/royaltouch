...
?>
    ...
    <head>
        ...
        <title><?php esc_attr_x('First time setup wizard - Cookie Information | Free WP GDPR Consent Plugin', 'admin', 'wp-gdpr-compliance'); ?></title>
            ...
            <div class="wpgdprc-container cell small-12">
                <div id="step-container">
                    ...
                    <div class="step-container__footer flex-container align-justify">
                        ...
                        <a data-step="done" href="<?php echo esc_url(Wizard::getFinishLink()) ?>"
