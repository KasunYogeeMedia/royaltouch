		...
		<div class="grid-x grid-margin-x grid-margin-y">
			<div class="cell cell--main large-4">
				<div class="wpgdprc-form__field">
                    <?php AdminForm::renderField('text', _x('Title of processor', 'admin', 'wp-gdpr-compliance'), $prefix . '[title]', $object->getTitle(), [
                        'class'       => 'regular-text',
                        'required'    => 'required',
				...
				<div class="wpgdprc-form__field">
                    <?php AdminForm::renderField('textarea', _x('Description', 'admin', 'wp-gdpr-compliance'), $prefix . '[description]', $object->getDescription(), [
                        'class'       => 'regular-text',
				...
				<div class="wpgdprc-form__field">
                    <?php AdminForm::renderField('select', _x('Code wrap', 'admin', 'wp-gdpr-compliance'), $prefix . '[wrap]', $object->getWrap(), [
                        'class'       => 'regular-text',
				...
				<div class="wpgdprc-form__field">
                    <?php AdminForm::renderField('select', _x('Placement', 'admin', 'wp-gdpr-compliance'), $prefix . '[placement]', $object->getPlacement(), [
                        'class'   => 'regular-text',
			...
			<div class="cell cell--aside large-8">
				<div class="wpgdprc-form__field wpgdprc-form__field--code">
                    <?php AdminForm::renderField('textarea', _x('Code snippet', 'admin', 'wp-gdpr-compliance'), $prefix . '[snippet]', htmlspecialchars($object->getSnippet(), ENT_QUOTES, get_option('blog_charset')), [
