    ...
    <nav class="wpgdprc-consent-modal__navigation">
        <ul class="wpgdprc-consent-modal__navigation-list">
            ...
            <?php foreach( $list as $item ) : ?>
                ...
                <li>
                    <button class="wpgdprc-consent-modal__navigation-button" data-target="<?php echo esc_attr($item->getId()); ?>"><?php echo esc_html(!empty($item->getTitle()) ? __($item->getTitle(), 'wp-gdpr-compliance') : __('(no title)', 'wp-gdpr-compliance')); ?></button>
                </li>
            <?php endforeach; ?>
        </ul>
    </nav>
    ...
    <div class="wpgdprc-consent-modal__information">
        ...
        <?php foreach( $list as $item ) : ?>
            ...
            <div class="wpgdprc-consent-modal__description" data-target="<?php echo esc_attr( $item->getId()); ?>">
                <p class="wpgdprc-consent-modal__title wpgdprc-consent-modal__title--description"><?php echo esc_html( __($item->getTitle(), 'wp-gdpr-compliance') ); ?></p>
                <div class="wpgdprc-content-modal__content">
