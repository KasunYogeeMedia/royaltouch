...
<div class="wpgdprc-checkbox">
    <label class="wpgdprc-switch wpgdprc-switch--column <?php echo esc_attr($class); ?>" for="<?php echo esc_attr($id); ?>">
        ...
        <span class="wpgdprc-switch__switch">
            <input class="wpgdprc-switch__input" type="checkbox" id="<?php echo esc_attr($id); ?>" name="<?php echo esc_attr($id); ?>"
                   value="<?php echo esc_attr($id); ?>" <?php checked(true, in_array($id, $consents)); ?> />
