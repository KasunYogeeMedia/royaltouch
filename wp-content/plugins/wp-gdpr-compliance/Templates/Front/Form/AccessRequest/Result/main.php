...
<form class="wpgdprc-form wpgdprc-form--delete-request" data-wpgdprc=<?php echo esc_attr($type); ?> method="POST" novalidate="novalidate">
	...
	<table class="wpgdprc-table">
        ...
        <?php foreach( $data as $id => $row ) : ?>
			<tr class="wpgdprc-table__tr wpgdprc-table__tr--tbody <?php if( $row[Data::COLUMN_ACTION] == Data::NO_ACTION ) echo esc_attr('wpgdprc-status--removed'); ?>" data-id="<?php echo esc_attr($id); ?>">
