...
if ( ! defined('TRX_ADDONS_CPT_TEAM_PT') ) define('TRX_ADDONS_CPT_TEAM_PT', 'cpt_team');
if ( ! defined('TRX_ADDONS_CPT_TEAM_TAXONOMY') ) define('TRX_ADDONS_CPT_TEAM_TAXONOMY', 'cpt_team_group');
...
if (!function_exists('trx_addons_cpt_team_init')) {
	...
	function trx_addons_cpt_team_init() {
		...
		register_post_type( TRX_ADDONS_CPT_TEAM_PT, array(
			...
			'rewrite'             => array( 'slug' => str_replace('cpt_', '', TRX_ADDONS_CPT_TEAM_PT) )
			)
		);
		...
		register_taxonomy( TRX_ADDONS_CPT_TEAM_TAXONOMY, TRX_ADDONS_CPT_TEAM_PT, array(
			...
			'query_var'         => true,
			'rewrite'           => array( 'slug' => str_replace('cpt_', '', TRX_ADDONS_CPT_TEAM_TAXONOMY) )
			)
		);
	}
}
...
if ( !function_exists( 'trx_addons_cpt_team_merge_styles' ) ) {
	...
	function trx_addons_cpt_team_merge_styles($css) {
		return $css . file_get_contents(trx_addons_get_file_dir('cpt/team/team.css'));
	}
}
