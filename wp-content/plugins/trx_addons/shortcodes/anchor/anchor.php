...
if ( !function_exists( 'trx_addons_sc_anchor_merge_styles' ) ) {
	...
	function trx_addons_sc_anchor_merge_styles($css) {
		return $css . file_get_contents(trx_addons_get_file_dir('shortcodes/anchor/anchor.css'));
	}
}
...
if ( !function_exists( 'trx_addons_sc_anchor_merge_scripts' ) ) {
	...
	function trx_addons_sc_anchor_merge_scripts($js) {
		return $js . file_get_contents(trx_addons_get_file_dir('shortcodes/anchor/anchor.js'));
	}
}
	
// Add shortcode's specific vars into JS storage
if ( !function_exists( 'trx_addons_sc_anchor_js_storage' ) ) {
	add_filter("trx_addons_js_storage", 'trx_addons_sc_anchor_js_storage');
	function trx_addons_sc_anchor_js_storage($storage) {
		return array_merge($storage, array(
