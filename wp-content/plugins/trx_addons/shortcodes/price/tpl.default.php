...
?><div <?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> 
	class="sc_price sc_price_default<?php if (!empty($args['class'])) echo ' '.esc_attr($args['class']); ?>"
	...
	?><div class="sc_price_info"><?php
		...
		if (!empty($args['title'])) {
			?><div class="sc_price_title"><?php echo esc_html($args['title']); ?></div><?php
		}
		...
		if ( ($content = do_shortcode($content))!='' ) {
			?><div class="sc_price_details"><?php echo wp_kses_data($content); ?></div><?php
		}
