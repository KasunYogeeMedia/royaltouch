...
if ($query->found_posts > 0) {
	...
	?><div class="sc_blogger sc_blogger_classic<?php if ($args['slider']) echo ' swiper-slider-container slider_swiper slider_no_controls'; ?>"<?php
		...
		while ( $query->have_posts() ) { $query->the_post();
			if (($fdir = trx_addons_get_file_dir('shortcodes/blogger/tpl.classic-item.php')) != '') { include $fdir; }
		}
