...
if ( !function_exists( 'trx_addons_sc_blogger_merge_styles' ) ) {
	...
	function trx_addons_sc_blogger_merge_styles($css) {
		return $css . file_get_contents(trx_addons_get_file_dir('shortcodes/blogger/blogger.css'));
	}
}
		...
		vc_map( apply_filters('trx_addons_sc_map', array(
				...
				"params" => array(
					...
					array(
						...
						"description" => wp_kses_data( __("Show post excerpt", 'trx_addons') ),
						"admin_label" => true,
						'dependency' => array(
							'element' => 'type',
							'value' => 'classic'
