...
if ( !function_exists( 'trx_addons_sc_icons_merge_styles' ) ) {
	...
	function trx_addons_sc_icons_merge_styles($css) {
		return $css . file_get_contents(trx_addons_get_file_dir('shortcodes/icons/icons.css'));
	}
}
...
if ( !function_exists( 'trx_addons_sc_icons_merge_scripts' ) ) {
	...
	function trx_addons_sc_icons_merge_scripts($js) {
		return $js . file_get_contents(trx_addons_get_file_dir('shortcodes/icons/vivus.js'))
				   . file_get_contents(trx_addons_get_file_dir('shortcodes/icons/icons.js'));
	}
}
