...
?><div id="<?php echo esc_attr($args['id']); ?>" 
	class="sc_icons sc_icons_default sc_icons_size_<?php echo esc_attr($args['size']); ?><?php if (!empty($args['align'])) echo ' sc_align_'.esc_attr($args['align']); ?><?php if (!empty($args['class'])) echo ' '.esc_attr($args['class']); ?>"
