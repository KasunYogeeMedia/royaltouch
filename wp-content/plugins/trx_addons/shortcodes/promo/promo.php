...
if ( !function_exists( 'trx_addons_sc_promo_merge_styles' ) ) {
	...
	function trx_addons_sc_promo_merge_styles($css) {
		return $css . file_get_contents(trx_addons_get_file_dir('shortcodes/promo/promo.css'));
	}
}
			...
			"params" => array_merge(
				...
				array(
					...
					array(
						...
						"description" => wp_kses_data( __("Size of the promo block: normal - one in the row, tiny - only image and title, small - in size two or greater columns, large - fullscreen height", 'trx_addons') ),
