...
class trx_addons_demo_data_importer {
	...
	function admin_scripts() {
        ...
        wp_enqueue_style( 'good_wine_shop-fontello',  good_wine_shop_get_file_url('css/fontello/css/fontello-embedded.css') );
	...
	function importer() {
		...
		if ( !isset($_POST['importer_action']) || !wp_verify_nonce( trx_addons_get_value_gp('ajax_nonce'), 'ajax_nonce' ) )
			die();
